            ...
            <Grid container sx={{ mt: "2rem" }}>
              ...
              > 
                  ...
                  <Grid    xs={6} item sx={{height:'75px'}}>
                    <Stack direction='column' justifyContent='space-around' sx={{height:"100%",ml:'1rem'}}>
                   <Box>   
                   Product Amount
                   </Box>
                   <Box>
                  ...
                  <Stack direction='column' alignItems='flex-end' justifyContent='space-around' sx={{height:"100%",mr:'1rem'}}>
                   <Box>   
                   {totalAmount}
                   </Box>
                   <Box>
